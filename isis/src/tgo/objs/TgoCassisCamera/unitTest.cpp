...
int main(void) {
  ...
  cout << "Unit Test for TgoCassisCamera..." << endl;
  try {
    ...
    double knownLat = 4.1185046573490665;
    double knownLon = 322.6163976791718824;
    ...
    if(abs(cam->UniversalLatitude() - knownLat) < 1E-10) {
      ...
      cout << setprecision(16) << "Latitude off by: " << cam->UniversalLatitude() -
                                                         knownLat << endl;
    }
    ...
    if(abs(cam->UniversalLongitude() - knownLon) < 1E-10) {
      ...
      cout << setprecision(16) << "Longitude off by: " << cam->UniversalLongitude() -
                                                          knownLon << endl;
    }
  }
  catch(IException &e) {
