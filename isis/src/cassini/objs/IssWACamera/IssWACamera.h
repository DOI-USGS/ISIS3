...
namespace Isis {
   ...
   *
   * This is the camera model for the Cassini Imaging Science Subsystem Wide
   * Angle Camera
   *
   ...
   *                          wrap with ISISnamespace. Added ISISDisclaimer
  ...
  class IssWACamera : public FramingCamera {
    public:
      IssWACamera(Cube &cube);
      //! Destroys the IssWACamera object.
      ~IssWACamera() {};
