...
//    printf("Median of R^2 residuals:  %lf\n", m_maximumLikelihoodMedianR2Residuals);
   ...
   *
   * @return @b Distance The maximum sigma for Coord1.
   */
   ...
   *
   * @return @b Distance The minimum sigma for Coord2.
   */
   ...
   *
   * @return @b Distance The maximum sigma for Coord2.
   */
   ...
   *
   * @return @b Distance The minimum sigma for Coord3.
   */
   ...
   *
   * @return @b Distance The maximum sigma for Coord3.
   */
   ...
   *
   * @return @b @QString The minimum sigma  point id for Coord1.
   */
   ...
   *
   * @return @b @QString The maximum sigma  point id for Coord1.
   */
   ...
   *
   * @return @b @QString The minimum sigma  point id for Coord2.
   */
   ...
   *
   * @return @b @QString The maximum sigma  point id for Coord2.
   */
   ...
   *
   * @return @b @QString The minimum sigma  point id for Coord3.
   */
   ...
   *
   * @return @b @QString The maximum sigma  point id for Coord3.
   */
