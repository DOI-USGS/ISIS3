...
void IsisMain() {
  ...
  keyword = PvlKeyword("LessThan", std::to_string(1));
  filterGrp += keyword;
  ...
  keyword = PvlKeyword("LessThan", std::to_string(10));
  filterGrp += keyword;
  keyword = PvlKeyword("GreaterThan", std::to_string(1));
  filterGrp += keyword;
  ...
  keyword = PvlKeyword("GreaterThan", std::to_string(2));
  filterGrp += keyword;
  keyword = PvlKeyword("LessThan", std::to_string(2));
  filterGrp += keyword;
  ...
  PvlKeyword keyword1("MinLat", std::to_string(-100));
  filterGrp += keyword1;

  PvlKeyword keyword2("MaxLat", std::to_string(100));
  filterGrp += keyword2;

  PvlKeyword keyword3("MinLon", std::to_string(0));
  filterGrp += keyword3;

  PvlKeyword keyword4("MaxLon", std::to_string(238));
  filterGrp += keyword4;
  ...
  keyword = PvlKeyword("MaxDistance", std::to_string(50000));
  filterGrp += keyword;
  ...
  keyword = PvlKeyword("LessThan", std::to_string(0.5));
  filterGrp += keyword;
  ...
  keyword = PvlKeyword("GreaterThan", std::to_string(10));
  filterGrp += keyword;
  keyword = PvlKeyword("LessThan", std::to_string(20));
  filterGrp += keyword;
  ...
  keyword = PvlKeyword("MaxDistance", std::to_string(100000));
  filterGrp += keyword;
  keyword = PvlKeyword("Units=", "meters");
  filterGrp += keyword;
  ...
  keyword = PvlKeyword("GreaterThan", std::to_string(0.2));
  filterGrp += keyword;
  keyword = PvlKeyword("LessThan", std::to_string(0.3));
  filterGrp += keyword;
