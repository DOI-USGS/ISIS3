 ...
 *
 * @return @b QString Returns a formatted QString representing the IsisBundleObservation
 *
 * @internal
 *   @history 2016-10-26 Ian Humphrey - Default values are now provided for parameters that are
 *                           not being solved. Fixes #4464.
 */
QString IsisBundleObservation::formatBundleOutputString(bool errorPropagation, bool imageCSV) {
