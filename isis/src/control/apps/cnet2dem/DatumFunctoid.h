...
class TypeCount : public DatumFunctoid {
  ...
  private:
    bool m_apply_sign;  // Distinguish radial search counts from nearest neighbor
                        // using a signed count for nearest neighbor
};
