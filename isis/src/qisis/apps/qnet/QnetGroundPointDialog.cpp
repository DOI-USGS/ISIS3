...
namespace Qisis {
  ...
  QString QnetGroundPointDialog::lastPtIdValue = "";
   ...
   * @internal
   */
  void QnetGroundPointDialog::SetFiles (QStringList &pointFiles) {
...
//        if (pos != -1) fileList->setItemSelected(item,true);
   ...
   *            to the p_ptIdValue 
   */
  void QnetGroundPointDialog::enableOkButton (const QString &text) {
    QnetGroundPointDialog::lastPtIdValue = ptIdValue->text();
