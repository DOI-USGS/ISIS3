...
namespace Qisis {
   ...
   *   @history 2010-06-02 Jeannie Walldren - Added overridden
   *                          reject() method to emit the
   *                          holdCancelled() signal to indicate
   *                          that the "Cancel" button was
   *                          clicked. This signal is connected in
