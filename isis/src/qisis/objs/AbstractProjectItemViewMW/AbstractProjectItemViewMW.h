#ifndef AbstractProjectItemViewMW_h
#define AbstractProjectItemViewMW_h
/**
 * @file
 * $Date$
 * $Revision$
...
namespace Isis {
   ...
   *                           Fixes #4299.
   */
  class AbstractProjectItemViewMW : public QMainWindow {

    Q_OBJECT

    public:
      AbstractProjectItemViewMW(QWidget *parent=0);
