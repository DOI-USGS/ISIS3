...
namespace Isis {
   ...
   */
  ShapeDisplayProperties::ShapeDisplayProperties(XmlStackedHandlerReader *xmlReader,
...
//  void ShapeDisplayProperties::fromPvl(const PvlObject &pvl) {
...
//   *   the shape filename.
//   */
//  PvlObject ShapeDisplayProperties::toPvl() const {
