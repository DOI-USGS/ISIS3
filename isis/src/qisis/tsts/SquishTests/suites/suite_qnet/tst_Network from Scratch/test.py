...
def main():
    ...
    mouseDrag(waitForObject(":Point ID:_QLineEdit_2"), 65, 8, -4, 0, 1, Qt.LeftButton)
    type(waitForObject(":Point ID:_QLineEdit_2"), "2")
    mouseDrag(waitForObject(":Point ID:_QLineEdit_2"), 72, 6, -10, 4, 1, Qt.LeftButton)
    ...
    mouseDrag(waitForObject(":Point ID:_QLineEdit_2"), 71, 8, -10, 1, 1, Qt.LeftButton)
    type(waitForObject(":Point ID:_QLineEdit_2"), "2")
    mouseDrag(waitForObject(":Point ID:_QLineEdit_2"), 74, 9, -15, 0, 1, Qt.LeftButton)
    type(waitForObject(":Point ID:_QLineEdit_2"), "1")
    clickButton(waitForObject(":Create New ControlPoint.OK_QPushButton"))
    clickButton(waitForObject(":New Point Id.OK_QPushButton"))
    sendEvent("QMouseEvent", waitForObject(":Point ID:_QLineEdit_2"), QEvent.MouseButtonPress, 109, 16, Qt.LeftButton, 1, 0)
    sendEvent("QMouseEvent", waitForObject(":Point ID:_QLineEdit_2"), QEvent.MouseButtonRelease, 57, 12, Qt.LeftButton, 0, 0)
    sendEvent("QKeyEvent", waitForObject(":Point ID:_QLineEdit_2"), QEvent.KeyPress, 50, 50, 0, "2", False, 1)
    clickButton(waitForObject(":Create New ControlPoint.OK_QPushButton"))
    clickButton(waitForObject(":QnetToolScroll.Save Point_QPushButton"))
