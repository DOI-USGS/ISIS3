...
This stylesheet will be used to generate the main TOC for the Guides and Tutorials page
...
-->
  ...
  <xsl:template match="tableofcontents">
    <html>
      <head>
        <title>
            USGS Isis: Guides and Tutorials
        </title>
        ...
        <meta name="description" content="User guides, tutorials, and advanced techniques for using the Integrated Software for Imagers and Spectrometers (ISIS), created and managed by the USGS Astrogeology Research Program. ISIS provides a comprehensive, user-friendly, portable tool for processing, analyzing, and displaying remotely sensed image data."/>
...
<!--
      ...
      <h3>Advanced &amp; Mission Specific Lessons</h3>
      <table class="tableTOC">
      <xsl:for-each select="//document[normalize-space(category/categoryItem) = 'tutorial' and
                                       normalize-space(category/categoryItem) != 'hidden' and
