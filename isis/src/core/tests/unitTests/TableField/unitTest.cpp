...
int main(int argc, char *argv[]) {
  ...
  group1 += PvlKeyword("size", Isis::toString(20));
  ...
  group2 += PvlKeyword("size", Isis::toString(20));
  ...
  group3 += PvlKeyword("size", Isis::toString(20));
  ...
  group4 += PvlKeyword("size", Isis::toString(20));
  ...
  try {
    ...
    group5 += PvlKeyword("size", Isis::toString(20));
  ...
  try {
    ...
    group6 += PvlKeyword("size", Isis::toString(-7.3));
