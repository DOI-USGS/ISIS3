...
namespace Isis {
  ...
  PvlGroup *CameraPointInfo::GetPointInfo(bool passed, bool allowOutside, bool allowErrors) {
    PvlGroup *gp = new PvlGroup("GroundPoint");
    {
      ...
      gp->addKeyword(PvlKeyword("CounterClockwise360Azimuth"));
      gp->addKeyword(PvlKeyword("CounterClockwise180Azimuth"));
      gp->addKeyword(PvlKeyword("Clockwise360Azimuth"));
      gp->addKeyword(PvlKeyword("Clockwise180Azimuth"));
    ...
    if(!noErrors) {
...

      {
        ...
        gp->findKeyword("CounterClockwise360Azimuth").setValue(toString(
          camera->UniversalLongitude()));
        // gp->findKeyword("PositiveEast360Longitude").setValue(toString(
        //   camera->UniversalLongitude()));

        //Convert lon to -180 - 180 range
        gp->findKeyword("CounterClockwise180Azimuth").setValue(toString(
        ...
        //Convert az to clockwise
        cwaz = Isis::RingPlaneProjection::ToClockwise(camera->UniversalLongitude(),
                360);
        gp->findKeyword("Clockwise360Azimuth").setValue(toString(cwaz));
        ...
        gp->findKeyword("Clockwise180Azimuth").setValue(toString(
