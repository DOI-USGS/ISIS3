...
int main(int argc, char *argv[]) {
  ...
  cout << endl;
  cout << "Min = " << cumDyn.min() << endl;
  cout << "Max = " << cumDyn.max() << endl;
  ...
  inputData >> newCumDyn;
  cout << "Min = " << newCumDyn.min() << endl;
  cout << "Max = " << newCumDyn.max() << endl << endl;
  cout << "Testing approximations after serialization" << endl;
  //double temp;
