 ...
 */                                                                       
  class TransverseMercator : public Isis::Projection {
    public:
      TransverseMercator(Isis::Pvl &label, bool allowDefaults=false);
      ~TransverseMercator();
       ...
       */
      std::string Name() const { return "TransverseMercator"; }
    ...
    private:
      ...
      double p_esp;
      double p_e0, p_e1, p_e2, p_e3;     //!<Eccentricity Constants
      double p_ml0;                /**<Distance along the meridian from the equator 
                                    to the center latitude.*/
      bool p_sph;                /**<Flag set to true if sphere, and false if 
                                    ellipsiod.*/
  };
};
#endif
