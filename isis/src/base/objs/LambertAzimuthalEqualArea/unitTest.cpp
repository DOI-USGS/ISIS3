...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    mapGroup.findKeyword("PolarRadius").setValue(std::to_string(6378388.0*sqrt(1-.00672267)));
    mapGroup.findKeyword("MinimumLatitude").setValue("-89.99999");
    mapGroup.findKeyword("CenterLongitude").setValue("-100.0");
    ...
    mapGroup.findKeyword("PolarRadius").setValue(std::to_string(6378206.4*sqrt(1-.00676866)));  
    mapGroup.findKeyword("CenterLatitude").setValue("40.0");                      
    mapGroup.findKeyword("CenterLongitude").setValue("-100.0");                   
    ...
    cout << border << endl << endl;
    //||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
    mapGroup.findKeyword("PolarRadius").setValue(std::to_string(p8->EquatorialRadius()));
