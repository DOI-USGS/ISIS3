#ifndef _CnetValidMeasure_h_
#define _CnetValidMeasure_h_
...
namespace Isis {
  ...
  class CnetValidMeasure {
    public:
      CnetValidMeasure(Pvl *pvl = 0);
      CnetValidMeasure(Pvl &pvl);
