...
namespace Isis {
  ...
  QString Environment::isisVersion() {
    TextFile versionFile(QString(ISISROOT) + "/version");
    ...
    if (validPartOfLine.indexIn(line1) != -1) {
      ...
      IString msg = QString(ISISROOT) + "/version line 1, no valid text found";
    ...
    if (validPartOfLine.indexIn(line2) != -1) {
      ...
      IString msg = QString(ISISROOT) + "/version line 2, no valid text found";
      throw IException(IException::Programmer, msg, _FILEINFO_);
    }
    ...
    if (validPartOfLine.indexIn(line4) != -1) {
      ...
      IString msg = QString(ISISROOT) + "/version line 4, no valid text found";
      throw IException(IException::Programmer, msg, _FILEINFO_);
    }
