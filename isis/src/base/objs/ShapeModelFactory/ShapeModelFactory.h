...
namespace Isis {
   ...
   *                           at this time.
   *   @history 2018-07-21 UA/OSIRIS-REx - Modified to use new Bullet interface
   *                           that supports sharing of single shape model
   *   @history 2018-09-14 UA/OSIRIS-REx - Changed up creation of Bullet shape
