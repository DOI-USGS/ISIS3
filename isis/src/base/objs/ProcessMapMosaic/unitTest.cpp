...
void IsisMain() {
  ...
  mapGroup.addKeyword(PvlKeyword("MaximumLatitude",  std::to_string(-4.7)), Pvl::Replace);
  mapGroup.addKeyword(PvlKeyword("MinimumLongitude", std::to_string(30.7)), Pvl::Replace);
  mapGroup.addKeyword(PvlKeyword("MaximumLongitude", std::to_string(31)), Pvl::Replace);
