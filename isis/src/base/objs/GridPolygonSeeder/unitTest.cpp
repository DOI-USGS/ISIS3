  ...
  try {
    ...
    do {
      if(!alg.hasKeyword("Name")) {
        ...
        alg += PvlKeyword("MinimumThickness", Isis::toString(0.3));
        alg += PvlKeyword("MinimumArea", Isis::toString(10));
        alg += PvlKeyword("XSpacing", Isis::toString(1500));
        alg += PvlKeyword("YSpacing", Isis::toString(1500));
      }
      else {
        cout << "Test with subgrid" << endl;
        alg += PvlKeyword("SubGrid", Isis::toString(true));
      }
      ...
      try {
        ...
        mapGroup += Isis::PvlKeyword("LongitudeDomain", Isis::toString(360));
        mapGroup += Isis::PvlKeyword("CenterLatitude", Isis::toString(0));
        mapGroup += Isis::PvlKeyword("CenterLongitude", Isis::toString(0));
