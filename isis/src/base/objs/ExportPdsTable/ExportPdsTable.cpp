...
namespace Isis {
  ...
  PvlObject ExportPdsTable::fillMetaData() {
    ...
    pdsTableLabelInfo.addKeyword(PvlKeyword("ROWS", Isis::toString(m_isisTable->Records())));
    pdsTableLabelInfo.addKeyword(PvlKeyword("COLUMNS", Isis::toString(m_isisTable->RecordFields())));
    pdsTableLabelInfo.addKeyword(PvlKeyword("ROW_BYTES", Isis::toString(m_rowBytes)));
    pdsTableLabelInfo.addKeyword(PvlKeyword("ROW_SUFFIX_BYTES", Isis::toString(m_outputRecordBytes - m_rowBytes)));
    ...
    for(int fieldIndex = 0; fieldIndex < m_isisTable->RecordFields(); fieldIndex++) {
      ...
      columnObj.addKeyword(PvlKeyword("COLUMN_NUMBER", Isis::toString(fieldIndex + 1)));
      ...
      columnObj.addKeyword(PvlKeyword("START_BYTE", Isis::toString(startByte)));
      startByte += columnBytes;
      columnObj.addKeyword(PvlKeyword("BYTES", Isis::toString(columnBytes)));
