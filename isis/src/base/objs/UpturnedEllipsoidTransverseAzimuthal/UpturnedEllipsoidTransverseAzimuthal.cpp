...
namespace Isis {
  ...
  PvlGroup UpturnedEllipsoidTransverseAzimuthal::Mapping() {
    ...
    mapping += PvlKeyword("CenterLongitude", std::to_string(m_lambda0 * RAD2DEG));
    return mapping;
  }
