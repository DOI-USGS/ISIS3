...
void IsisMain() {
  ...
  ui.PutFileName("FROM",  "$odyssey/testData/I00831002RDR.even.cub");
  ui.PutFileName("FROM2", "$odyssey/testData/I00831002RDR.odd.cub");
  ...
  ui.Clear("FROM");
  ui.Clear("TO");
  ui.PutAsString("FROM", "$odyssey/testData/I00831002RDR.cub");
...
void PipeContinue(void)
{
  ...
  pc1.SetInputFile(FileName("$mro/testData/PSP_001446_1790_BG12_0.cub"));
  ...
  pc2.SetInputFile(FileName("$mro/testData/PSP_001446_1790_BG12_0.cub"));
