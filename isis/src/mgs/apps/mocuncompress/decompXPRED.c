...
void decompXPRED(curLine,size,code,left,right,bitStuff) register uint8 *curLine; uint32 size; uint8 *code,*left,*right; BITSTRUCT *bitStuff; {
...
uint32 tryXpred(code,left,right,bitStuff) uint8 *code,*left,*right; BITSTRUCT *bitStuff; {
uint32 nerror;
