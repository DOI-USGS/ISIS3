...
void decompYPRED(curLine,prevLine,size,code,left,right,bitStuff) register uint8 *curLine,*prevLine; register uint32 size; uint8 *code,*left,*right; BITSTRUCT *bitStuff; {
...
uint32 tryYpred(code,left,right,bitStuff) uint8 *code,*left,*right; BITSTRUCT *bitStuff; {
uint32 nerror;
