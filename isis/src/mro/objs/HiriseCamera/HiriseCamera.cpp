...
namespace Isis {
   ...
   * @return QString
   */
  QString HiriseCamera::instrumentNameLong() const {
   ...
   * @return QString
   */
  QString HiriseCamera::instrumentNameShort() const {
   ...
   * @return QString
   */
  QString HiriseCamera::spacecraftNameLong() const {
   ...
   * @return QString
   */
  QString HiriseCamera::spacecraftNameShort() const {
