...
void defineFilenames() {
  UserInterface &ui = Application::GetUserInterface();
  Filename fn;
  fn.Temporary("hinoise-zap", "cub");
  g_zapFilename = fn.Expanded();
  fn.Temporary("hinoise-lpf", "cub");
  g_lpfFilename = fn.Expanded();
  fn.Temporary("hinoise-hpf", "cub");
  g_hpfFilename = fn.Expanded();
  fn.Temporary("hinoise-add", "cub");
  g_addFilename = fn.Expanded();
  fn.Temporary("hinoise-noisefilter1", "cub");
  g_noisefilter1Filename = fn.Expanded();
  fn.Temporary("hinoise-noisefilter2", "cub");
  g_noisefilter2Filename = fn.Expanded();
  fn.Temporary("hinoise-noisefilter3", "cub");
  g_noisefilter3Filename = fn.Expanded();
  fn.Temporary("hinoise-lpfz1", "cub");
  g_lpfz1Filename = fn.Expanded();
  fn.Temporary("hinoise-lpfz2", "cub");
  g_lpfz2Filename = fn.Expanded();
