...
TEST(FunctionalTestMimap2Isis, Default) {
  ...
  EXPECT_DOUBLE_EQ(std::stod( pixels.findKeyword("Base")), 0.0);
  EXPECT_DOUBLE_EQ(std::stod( pixels.findKeyword("Multiplier")), 2.0e-05);
  ...
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMaximumDn")[0]), 32268);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMaximumDn")[1]), 32178);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMaximumDn")[2]), 32562);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMaximumDn")[3]), 31727);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMaximumDn")[4]), 32684);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMaximumDn")[5]), 32528);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMaximumDn")[6]), 32179);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMaximumDn")[7]), 32293);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMaximumDn")[8]), 32433);

  for (int i = 0; i < 7; i++) {
    EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMinimumDn")[i]), 0) << "Error at index: " << i;;
  }
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMinimumDn")[8]), 1);

  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneAverageDn")[0]), 3096.5);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneAverageDn")[1]), 5582.3);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneAverageDn")[2]), 5993.3);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneAverageDn")[3]), 6101.0);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneAverageDn")[4]), 6480.5);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneAverageDn")[5]), 6425.4);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneAverageDn")[6]), 6767.4);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneAverageDn")[7]), 8075.3);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneAverageDn")[8]), 9526.2);

  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneStdevDn")[0]), 1232.1);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneStdevDn")[1]), 1933.4);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneStdevDn")[2]), 2080.3);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneStdevDn")[3]), 2053.8);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneStdevDn")[4]), 2138.1);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneStdevDn")[5]), 2049.9);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneStdevDn")[6]), 2110.4);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneStdevDn")[7]), 2367.1);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneStdevDn")[8]), 2629.7);

  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneModeDn")[0]), 2980);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneModeDn")[1]), 5635);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneModeDn")[2]), 3);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneModeDn")[3]), 6095);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneModeDn")[4]), 6324);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneModeDn")[5]), 0);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneModeDn")[6]), 0);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneModeDn")[7]), 7965);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneModeDn")[8]), 9305);

  for (int i = 0; i < 9; i++) {
    EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("ShadowedAreaMinimum")[i]), 0) << "Error at index: " << i;
    EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("ShadowedAreaMaximum")[i]), 327) << "Error at index: " << i;
  }

  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("ShadowedAreaPercentage")[0]), 2);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("ShadowedAreaPercentage")[1]), 2);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("ShadowedAreaPercentage")[2]), 2);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("ShadowedAreaPercentage")[3]), 2);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("ShadowedAreaPercentage")[4]), 1);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("ShadowedAreaPercentage")[5]), 3);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("ShadowedAreaPercentage")[6]), 2);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("ShadowedAreaPercentage")[7]), 1);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("ShadowedAreaPercentage")[8]), 1);
  ...
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("InvalidValue")[0]), -20000);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("InvalidValue")[1]), -21000);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("InvalidValue")[2]), -22000);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("InvalidValue")[3]), -23000);
  ...
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("OutOfImageBoundsValue")), -30000);

  for (int i = 0; i < 9; i++) {
    EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("OutOfImageBoundsPixel")[i]), 0) << "Error at index: " << i;
  }
  ...
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("RefCnvCoef")[0]), 0.002353311);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("RefCnvCoef")[1]), 0.002450451);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("RefCnvCoef")[2]), 0.003549924);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("RefCnvCoef")[3]), 0.003886012);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("RefCnvCoef")[4]), 0.004316842);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("RefCnvCoef")[5]), 0.004316842);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("RefCnvCoef")[6]), 0.004893535);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("RefCnvCoef")[7]), 0.007400877);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("RefCnvCoef")[8]), 0.01218292);

  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("StandardGeometry")[0]), 30.0);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("StandardGeometry")[1]), 0.0);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("StandardGeometry")[2]), 30.0);
  ...
  for (int i = 0; i < 5; i++) {
    ...
    EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("L2aSaturationThreshold")[i]), 1023) << "Error at index: " << i;
  ...
  for (int i = 5; i < 9; i++) {
    ...
    EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("DarkValidMinimum")[i]), -10) << "Error at index: " << i;
  }

  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("FtValidMinimum")), -2);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("RadianceSaturationThreshold")), 425.971);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("RefSaturationThreshold")), 0.65534);

  // BandBin Group
  PvlGroup &bandbin = isisLabel->findGroup("BandBin", Pvl::Traverse);
  for (int i = 0; i < 5; i++) {
    EXPECT_PRED_FORMAT2(AssertStringsEqual, bandbin.findKeyword("FilterName")[i], "MV" + std::to_string(i + 1)) << "Error at index: " << i;
  }
  for (int i = 5; i < 9; i++) {
    EXPECT_PRED_FORMAT2(AssertStringsEqual, bandbin.findKeyword("FilterName")[i], "MN" + std::to_string(i - 4)) << "Error at index: " << i;
  }

  EXPECT_DOUBLE_EQ(std::stod(bandbin.findKeyword("Center")[0]), 414.0);
  EXPECT_DOUBLE_EQ(std::stod(bandbin.findKeyword("Center")[1]), 749.0);
  EXPECT_DOUBLE_EQ(std::stod(bandbin.findKeyword("Center")[2]), 901.0);
  EXPECT_DOUBLE_EQ(std::stod(bandbin.findKeyword("Center")[3]), 950.0);
  EXPECT_DOUBLE_EQ(std::stod(bandbin.findKeyword("Center")[4]), 1001.0);
  EXPECT_DOUBLE_EQ(std::stod(bandbin.findKeyword("Center")[5]), 1000.0);
  EXPECT_DOUBLE_EQ(std::stod(bandbin.findKeyword("Center")[6]), 1049.0);
  EXPECT_DOUBLE_EQ(std::stod(bandbin.findKeyword("Center")[7]), 1248.0);
  EXPECT_DOUBLE_EQ(std::stod(bandbin.findKeyword("Center")[8]), 1548.0);

  EXPECT_DOUBLE_EQ(std::stod(bandbin.findKeyword("Width")[0]), 20.0);
  EXPECT_DOUBLE_EQ(std::stod(bandbin.findKeyword("Width")[1]), 12.0);
  EXPECT_DOUBLE_EQ(std::stod(bandbin.findKeyword("Width")[2]), 21.0);
  EXPECT_DOUBLE_EQ(std::stod(bandbin.findKeyword("Width")[3]), 30.0);
  EXPECT_DOUBLE_EQ(std::stod(bandbin.findKeyword("Width")[4]), 42.0);
  EXPECT_DOUBLE_EQ(std::stod(bandbin.findKeyword("Width")[5]), 27.0);
  EXPECT_DOUBLE_EQ(std::stod(bandbin.findKeyword("Width")[6]), 28.0);
  EXPECT_DOUBLE_EQ(std::stod(bandbin.findKeyword("Width")[7]), 33.0);
  EXPECT_DOUBLE_EQ(std::stod(bandbin.findKeyword("Width")[8]), 48.0);
...
TEST(FunctionalTestMimap2Isis, L3C) {
  ...
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMaximumDn")[0]), 20866);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMaximumDn")[1]), 31905);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMaximumDn")[2]), 32710);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMaximumDn")[3]), 32352);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMaximumDn")[4]), 32589);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMaximumDn")[5]), 32644);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMaximumDn")[6]), 32670);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMaximumDn")[7]), 32720);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMaximumDn")[8]), 32673);

  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMinimumDn")[0]), 6);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMinimumDn")[1]), 14);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMinimumDn")[2]), 12);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMinimumDn")[3]), 18);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMinimumDn")[4]), 23);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMinimumDn")[5]), 0);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMinimumDn")[6]), 0);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMinimumDn")[7]), 0);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMinimumDn")[8]), 11);

  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneAverageDn")[0]), 5313.7);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneAverageDn")[1]), 9108.2);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneAverageDn")[2]), 9735.2);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneAverageDn")[3]), 9950.5);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneAverageDn")[4]), 10454.1);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneAverageDn")[5]), 9948.5);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneAverageDn")[6]), 10312.5);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneAverageDn")[7]), 11676.5);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneAverageDn")[8]), 13360.7);

  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneStdevDn")[0]), 2756.2);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneStdevDn")[1]), 4579.0);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneStdevDn")[2]), 5173.3);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneStdevDn")[3]), 4877.5);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneStdevDn")[4]), 5046.1);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneStdevDn")[5]), 5216.4);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneStdevDn")[6]), 5294.5);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneStdevDn")[7]), 5561.1);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneStdevDn")[8]), 5645.0);

  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneModeDn")[0]), 4834);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneModeDn")[1]), 8614);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneModeDn")[2]), 8969);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneModeDn")[3]), 9179);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneModeDn")[4]), 9650);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneModeDn")[5]), 0);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneModeDn")[6]), 0);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneModeDn")[7]), 0);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneModeDn")[8]), 13310);
  ...
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("ShadowedAreaPercentage")[0]), 1);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("ShadowedAreaPercentage")[1]), 0);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("ShadowedAreaPercentage")[2]), 1);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("ShadowedAreaPercentage")[3]), 0);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("ShadowedAreaPercentage")[4]), 0);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("ShadowedAreaPercentage")[5]), 6);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("ShadowedAreaPercentage")[6]), 5);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("ShadowedAreaPercentage")[7]), 2);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("ShadowedAreaPercentage")[8]), 0);
  ...
  for (int i = 0; i < 9; i++) {
    EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("OutOfImageBoundsPixel")[i]), 1642126) << "Error at index: " << i;
  }
  ...
  EXPECT_NEAR(std::stod(archive.findKeyword("RadCnvCoef")[0]), 1.470593, .000001);
  EXPECT_NEAR(std::stod(archive.findKeyword("RadCnvCoef")[1]), 2.204781, .000001);
  EXPECT_NEAR(std::stod(archive.findKeyword("RadCnvCoef")[2]), 2.244315, .000001);
  EXPECT_NEAR(std::stod(archive.findKeyword("RadCnvCoef")[3]), 2.734361, .000001);
  EXPECT_NEAR(std::stod(archive.findKeyword("RadCnvCoef")[4]), 1.885889, .000001);
  EXPECT_NEAR(std::stod(archive.findKeyword("RadCnvCoef")[5]), 3.04924, .000001);
  EXPECT_NEAR(std::stod(archive.findKeyword("RadCnvCoef")[6]), 3.312096, .000001);
  EXPECT_NEAR(std::stod(archive.findKeyword("RadCnvCoef")[7]), 4.788256, .000001);
  EXPECT_NEAR(std::stod(archive.findKeyword("RadCnvCoef")[8]), 7.969085, .000001);
...
TEST(FunctionalTestMimap2Isis, MAPv3) {
  ...
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMaximumDn")[0]), 11914);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMaximumDn")[1]), 18693);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMaximumDn")[2]), 22004);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMaximumDn")[3]), 21392);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMaximumDn")[4]), 22057);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMaximumDn")[5]), 19521);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMaximumDn")[6]), 20790);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMaximumDn")[7]), 22610);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMaximumDn")[8]), 27149);

  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMinimumDn")[0]), 2336);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMinimumDn")[1]), 4236);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMinimumDn")[2]), 4020);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMinimumDn")[3]), 4643);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMinimumDn")[4]), 4957);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMinimumDn")[5]), 5559);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMinimumDn")[6]), 5804);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMinimumDn")[7]), 6892);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneMinimumDn")[8]), 8121);

  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneAverageDn")[0]), 3739.9);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneAverageDn")[1]), 6790.8);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneAverageDn")[2]), 7729.2);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneAverageDn")[3]), 7954.9);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneAverageDn")[4]), 8312.9);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneAverageDn")[5]), 8080.9);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneAverageDn")[6]), 8416.3);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneAverageDn")[7]), 9692.3);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneAverageDn")[8]), 11512.4);

  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneStdevDn")[0]), 528.9);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneStdevDn")[1]), 785.4);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneStdevDn")[2]), 860.7);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneStdevDn")[3]), 826.7);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneStdevDn")[4]), 837.4);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneStdevDn")[5]), 798.7);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneStdevDn")[6]), 837.1);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneStdevDn")[7]), 882.8);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneStdevDn")[8]), 1005.1);

  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneModeDn")[0]), 3495);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneModeDn")[1]), 6483);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneModeDn")[2]), 7484);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneModeDn")[3]), 7645);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneModeDn")[4]), 8086);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneModeDn")[5]), 7789);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneModeDn")[6]), 8103);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneModeDn")[7]), 9429);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("SceneModeDn")[8]), 11274);
  ...
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("ShadowedAreaPercentage")[0]), 0);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("ShadowedAreaPercentage")[1]), 0);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("ShadowedAreaPercentage")[2]), 0);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("ShadowedAreaPercentage")[3]), 0);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("ShadowedAreaPercentage")[4]), 0);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("ShadowedAreaPercentage")[5]), 0);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("ShadowedAreaPercentage")[6]), 0);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("ShadowedAreaPercentage")[7]), 0);
  EXPECT_DOUBLE_EQ(std::stod(archive.findKeyword("ShadowedAreaPercentage")[8]), 0);
