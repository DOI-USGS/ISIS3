...
TEST(Chan1m32Isis, Chan1m32IsisTestFowardAscending) {
  ...
  QVector<QString> args = {"from=data/chan1m32isis/forwardAscending/M3T20090630T083407_V03_L1B_cropped.LBL",
                           "loc=data/chan1m32isis/forwardAscending/M3T20090630T083407_V03_LOC_cropped.IMG",
                           "obs=data/chan1m32isis/forwardAscending/M3T20090630T083407_V03_OBS_cropped.IMG",
                           "to=" + cubeFileName };
  ...
  ASSERT_EQ(int(dimensions["Samples"]), 608);
...
TEST(Chan1m32Isis, Chan1m32IsisTestFowardDescending) {
  ...
  QVector<QString> args = {"from=data/chan1m32isis/forwardDescending/M3G20081129T171431_V03_L1B_cropped.LBL",
                           "loc=data/chan1m32isis/forwardDescending/M3G20081129T171431_V03_LOC_cropped.IMG",
                           "obs=data/chan1m32isis/forwardDescending/M3G20081129T171431_V03_OBS_cropped.IMG",
                           "to=" + cubeFileName };
...
TEST(Chan1m32Isis, Chan1m32IsisTestReverseDescending) {
  ...
  QVector<QString> args = {"from=data/chan1m32isis/reverseDescending/M3G20090106T113423_V03_L1B_cropped.LBL",
                           "loc=data/chan1m32isis/reverseDescending/M3G20090106T113423_V03_LOC_cropped.IMG",
                           "obs=data/chan1m32isis/reverseDescending/M3G20090106T113423_V03_OBS_cropped.IMG",
                           "to=" + cubeFileName };
...
TEST(Chan1m32Isis, Chan1m32IsisTestReverseAscending) {
  ...
  QVector<QString> args = {"from=data/chan1m32isis/reverseAscending/M3G20090423T191900_V03_L1B_cropped.LBL",
                           "loc=data/chan1m32isis/reverseAscending/M3G20090423T191900_V03_LOC_cropped.IMG",
                           "obs=data/chan1m32isis/reverseAscending/M3G20090423T191900_V03_OBS_cropped.IMG",
                           "to=" + cubeFileName };
...
TEST(Chan1m32Isis, Chan1m32IsisTestLinerateNotConstant) {
  ...
  ASSERT_EQ(inst["InstrumentId"][0].toStdString(), "M3" );
  ASSERT_EQ(inst["TargetName"][0].toStdString(), "MOON" );
  ASSERT_EQ(inst["SpacecraftClockStartCount"][0].toStdString(), "2/0599698.897" );
  ASSERT_EQ(inst["SpacecraftClockStopCount"][0].toStdString(), "2/0599699.406" );
  ASSERT_DOUBLE_EQ(double(inst["LineExposureDuration"]), 101.76);
  ASSERT_DOUBLE_EQ(double(inst["SpatialSumming"]), 2);
  ASSERT_EQ(inst["StartTime"][0].toStdString(), "2008-11-18T22:32:03.411111" );
  ASSERT_EQ(inst["StopTime"][0].toStdString(), "2008-11-18T22:32:03.919905" );
  ASSERT_EQ(inst["SpacecraftYawDirection"][0].toStdString(), "FORWARD" );
  ASSERT_EQ(inst["OrbitLimbDirection"][0].toStdString(), "DESCENDING" );
