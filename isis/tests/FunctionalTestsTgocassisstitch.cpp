...
TEST(TgoCassisstitch, TgoCassisstitchMultiframeTest) {
  ...
  cubeList->append("data/tgoCassis/CAS-MCO-2016-11-22T16.16.16.833-BLU-03006-B1.cub");
  cubeList->append("data/tgoCassis/CAS-MCO-2016-11-22T16.16.16.833-RED-01006-B1_crop.cub");
  cubeList->append("data/tgoCassis/CAS-MCO-2016-11-22T16.16.16.833-NIR-02006-B1_crop.cub");
  cubeList->append("data/tgoCassis/CAS-MCO-2016-11-22T16.16.16.833-PAN-00006-B1_crop.cub");
