...
TEST(Pds2Isis, Pds2isisTestDefault) {
  ...
  ASSERT_EQ(std::stod(pixels["Base"]), 0.0);
  ASSERT_EQ(std::stod(pixels["Multiplier"]), 1.0);
...
TEST(Pds2Isis, Pds2isisTestBandBin) {
  ...
  ASSERT_EQ(std::stod(bandbin["Center"][0]),  0.7360);
  ASSERT_EQ(std::stod(bandbin["Center"][1]),  0.8750);
  ASSERT_EQ(std::stod(bandbin["Center"][2]),  1.0546);
  ASSERT_EQ(std::stod(bandbin["Center"][3]),  1.3326);
  ASSERT_EQ(std::stod(bandbin["Center"][4]),  1.6110);
  ASSERT_EQ(std::stod(bandbin["Center"][5]),  1.8914);
  ASSERT_EQ(std::stod(bandbin["Center"][6]),  2.1728);
  ASSERT_EQ(std::stod(bandbin["Center"][7]),  2.4529);
  ASSERT_EQ(std::stod(bandbin["Center"][8]),  2.7382);
  ASSERT_EQ(std::stod(bandbin["Center"][9]),  3.0178);
  ASSERT_EQ(std::stod(bandbin["Center"][10]), 3.3012);
  ASSERT_EQ(std::stod(bandbin["Center"][11]), 3.5839);
  ASSERT_EQ(std::stod(bandbin["Center"][12]), 3.8670);
  ASSERT_EQ(std::stod(bandbin["Center"][13]), 4.1503);
  ASSERT_EQ(std::stod(bandbin["Center"][14]), 4.4343);
  ASSERT_EQ(std::stod(bandbin["Center"][15]), 4.7164);
  ASSERT_EQ(std::stod(bandbin["Center"][16]), 4.9988);

  ASSERT_EQ(std::stod(bandbin["Width"][0]),  0.0125);
  ASSERT_EQ(std::stod(bandbin["Width"][1]),  0.0125);
  ASSERT_EQ(std::stod(bandbin["Width"][2]),  0.0250);
  ASSERT_EQ(std::stod(bandbin["Width"][3]),  0.0250);
  ASSERT_EQ(std::stod(bandbin["Width"][4]),  0.0250);
  ASSERT_EQ(std::stod(bandbin["Width"][5]),  0.0250);
  ASSERT_EQ(std::stod(bandbin["Width"][6]),  0.0250);
  ASSERT_EQ(std::stod(bandbin["Width"][7]),  0.0250);
  ASSERT_EQ(std::stod(bandbin["Width"][8]),  0.0250);
  ASSERT_EQ(std::stod(bandbin["Width"][9]),  0.0250);
  ASSERT_EQ(std::stod(bandbin["Width"][10]), 0.0250);
  ASSERT_EQ(std::stod(bandbin["Width"][11]), 0.0250);
  ASSERT_EQ(std::stod(bandbin["Width"][12]), 0.0250);
  ASSERT_EQ(std::stod(bandbin["Width"][13]), 0.0250);
  ASSERT_EQ(std::stod(bandbin["Width"][14]), 0.0250);
  ASSERT_EQ(std::stod(bandbin["Width"][15]), 0.0250);
  ASSERT_EQ(std::stod(bandbin["Width"][16]), 0.0250);

  ASSERT_EQ(std::stoi(bandbin["FilterNumber"][0]),  1);
  ASSERT_EQ(std::stoi(bandbin["FilterNumber"][1]),  2);
  ASSERT_EQ(std::stoi(bandbin["FilterNumber"][2]),  3);
  ASSERT_EQ(std::stoi(bandbin["FilterNumber"][3]),  4);
  ASSERT_EQ(std::stoi(bandbin["FilterNumber"][4]),  5);
  ASSERT_EQ(std::stoi(bandbin["FilterNumber"][5]),  6);
  ASSERT_EQ(std::stoi(bandbin["FilterNumber"][6]),  7);
  ASSERT_EQ(std::stoi(bandbin["FilterNumber"][7]),  8);
  ASSERT_EQ(std::stoi(bandbin["FilterNumber"][8]),  9);
  ASSERT_EQ(std::stoi(bandbin["FilterNumber"][9]),  10);
  ASSERT_EQ(std::stoi(bandbin["FilterNumber"][10]), 11);
  ASSERT_EQ(std::stoi(bandbin["FilterNumber"][11]), 12);
  ASSERT_EQ(std::stoi(bandbin["FilterNumber"][12]), 13);
  ASSERT_EQ(std::stoi(bandbin["FilterNumber"][13]), 14);
  ASSERT_EQ(std::stoi(bandbin["FilterNumber"][14]), 15);
  ASSERT_EQ(std::stoi(bandbin["FilterNumber"][15]), 16);
  ASSERT_EQ(std::stoi(bandbin["FilterNumber"][16]), 17);
...
TEST(Pds2Isis, Pds2isisTestOffset) {
  ...
  ASSERT_EQ(std::stod(mapping["CenterLongitude"]), 180.0);
  ASSERT_EQ(mapping["TargetName"][0], "Moon");
  ASSERT_EQ(std::stod(mapping["EquatorialRadius"]), 1737400.0);
  ASSERT_EQ(std::stod(mapping["PolarRadius"]), 1737400.0);
  ...
  ASSERT_EQ(std::stod(mapping["MinimumLatitude"]), -90.0);
  ASSERT_EQ(std::stod(mapping["MaximumLatitude"]), 90.0);
  ASSERT_EQ(std::stod(mapping["MinimumLongitude"]), 0.0);
  ASSERT_EQ(std::stod(mapping["MaximumLongitude"]), 360.0);
  ASSERT_EQ(std::stod(mapping["UpperLeftCornerX"]), -5458204.8);
  ASSERT_EQ(std::stod(mapping["UpperLeftCornerY"]), 2729102.4);
  ASSERT_EQ(std::stod(mapping["PixelResolution"]), 7580.84);
  ASSERT_EQ(std::stod(mapping["Scale"]), 4.0);
...
TEST(Pds2Isis, Pds2isisTestProjection) {
  ...
  ASSERT_EQ(std::stod(mapping["CenterLongitude"]), 325.3829);
  ASSERT_EQ(mapping["TargetName"][0], "Venus");
  ASSERT_EQ(std::stod(mapping["EquatorialRadius"]), 6051920.0);
  ASSERT_EQ(std::stod(mapping["PolarRadius"]), 6051920.0);
  ASSERT_EQ(mapping["LatitudeType"][0], "Planetocentric");
  ASSERT_EQ(mapping["LongitudeDirection"][0], "PositiveEast");
  ASSERT_EQ((int)mapping["LongitudeDomain"], 360);
  ASSERT_EQ(std::stod(mapping["MinimumLatitude"]), -29.6357);
  ASSERT_EQ(std::stod(mapping["MaximumLatitude"]), -28.9092);
  ASSERT_EQ(std::stod(mapping["MinimumLongitude"]), 322.0367);
  ASSERT_EQ(std::stod(mapping["MaximumLongitude"]), 322.8903);
  ASSERT_EQ(std::stod(mapping["UpperLeftCornerX"]), -307162.5);
  ASSERT_EQ(std::stod(mapping["UpperLeftCornerY"]), -3053025.0);
  ASSERT_EQ(std::stod(mapping["PixelResolution"]), 75.0);
  ASSERT_EQ(std::stod(mapping["Scale"]), 1407.4);
