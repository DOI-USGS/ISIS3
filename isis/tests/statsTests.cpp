...
TEST_F(stats_MockHist, TestStats) {
  ...
  EXPECT_TRUE("N/A" == band2Stats.findKeyword("Average")[0]);
  EXPECT_TRUE("N/A" == band2Stats.findKeyword("StandardDeviation")[0]);
  EXPECT_TRUE("N/A" == band2Stats.findKeyword("Variance")[0]);
  EXPECT_TRUE("N/A" == band2Stats.findKeyword("Median")[0]);
  EXPECT_TRUE("N/A" == band2Stats.findKeyword("Mode")[0]);
  EXPECT_TRUE("N/A" == band2Stats.findKeyword("Skew")[0]);
  EXPECT_TRUE("N/A" == band2Stats.findKeyword("Minimum")[0]);
  EXPECT_TRUE("N/A" == band2Stats.findKeyword("Maximum")[0]);
  EXPECT_TRUE("N/A" == band2Stats.findKeyword("Sum")[0]);
}
