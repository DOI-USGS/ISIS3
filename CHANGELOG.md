...
- Fixed serial number generation for CSM cubes so jigsaw can read them, and made jigsaw report a clear error when a control network's serial numbers no longer match the input images ([#5482](https://github.com/DOI-USGS/ISIS3/issues/5482), [#4240](https://github.com/DOI-USGS/ISIS3/issues/4240))
...
- Added SpiceQL integration to replace cspice calls. ([#5545](https://github.com/DOI-USGS/ISIS3/issues/5545))
- Added initial `eisstitch` app ([#5591](https://github.com/DOI-USGS/ISIS3/issues/5591))
...
- Added support for reading, writing, and viewing GeoTIFFs in ISIS. ([#5618](https://github.com/DOI-USGS/ISIS3/issues/5618))
- Added serial number translation for ideal camera ([#5662](https://github.com/DOI-USGS/ISIS3/issues/5662))
- Added adjusted XYZ point coordinate sigmas to the points.csv jigsaw output file. Modified ctest FunctionalTestJigsawApollo to validate this output. ([#5710](https://github.com/DOI-USGS/ISIS3/issues/5710))
- Added GDAL SRS propagation for systems outside of ISIS to display projected GTiffs. ([#5736](https://github.com/DOI-USGS/ISIS3/issues/5736))
- Added use Bullet Anaconda feedstock library, which includes double precision support, and fix ISIS use of general Bullet configurations. ([#5772](https://github.com/DOI-USGS/ISIS3/issues/5772))
- Added support for Chandrayaan-2 TMC and OHRC cameras. ([#5828](https://github.com/DOI-USGS/ISIS3/issues/5828))
...
- Changed file format to propagate from the input image format to the output image format ([#5737](https://github.com/DOI-USGS/ISIS3/issues/5737))
- Removed Arm dependency on xalan-c, as it does not build for now on conda-forge. This requires turning off doc building on Arm. Also changed some variables to avoid name clashes on Arm with clang 16. ([#5802](https://github.com/DOI-USGS/ISIS3/issues/5802))
- Changed `PVL` class to read data from GDAL metadata directly ([#5824](https://github.com/DOI-USGS/ISIS3/issues/5824))
- Pinned SpiceQL to 1.2.0 ([#5852](https://github.com/DOI-USGS/ISIS3/issues/5852))
- Changed `ControlMeasure` object comparison to no longer factor in creation date for equality ([#5862](https://github.com/DOI-USGS/ISIS3/issues/5862))
- Updated cmake configs to accommodate new cspice release ([#5886](https://github.com/DOI-USGS/ISIS3/issues/5886))
...
- Changed 'jigsaw' attribute type to account for Linux compiler changes ([#5904](https://github.com/DOI-USGS/ISIS3/issues/5904))
...
- QT 6 removed MySQL support so MySQL is no longer supported in `isisminer` ([#5909](https://github.com/DOI-USGS/ISIS3/issues/5909))
