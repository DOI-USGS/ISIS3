...
- Changed `BundleObservationSolveSettings` to set 0 coefficients for camera angle and camera position if None were defined [#5822](https://github.com/DOI-USGS/ISIS3/pull/5822)
